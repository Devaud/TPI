{ ****************************************************************************
  ...
  ***         Modification :                                               ***
  ***           06.05.2015 - AD - Ajout de l'ajout de séances              ***
  ***                             Ajout de la modification de séances      ***
  ***           07.05.2015 - AD - Modificatoin de la modification          ***
  ***                             Ajout de la supression de séances        ***
...
// Tableau pour les clés et les valeurs des champs pour le fichier INI
Type
...
const
  ...
  MAX_TABLEAU_CLEVAL_INDICE : integer = 7;  // Taille maximum de la première dimension du tableau
...
{ ****************************************************************************
  ...
  *** @params String parametre - Nom du paramètre dans le fichier INI      ***
  *** @params TCleVal ValCle - Clé et valeur à entrer dans le fichier INI  ***
  *** @result boolean - Renvoi vrai si tout c'est bien passé               ***
  **************************************************************************** }
...
Begin
  ...
  Begin
    ...
    // Parcoure le tableau et ajoute les éléments
...
Begin
  ...
  Begin
    ...
    FichierIni.ReadSections(Section); // Récupère toutes les sections
...
{ ****************************************************************************
  ...
  *** @params String heure - Heure à vérifier                              ***
...
{ ****************************************************************************
  ...
  *** @params TCombobox cbs - Combobox où l'on cherche notre élément       ***
  *** @params string item - nom de l'élément choisi                        ***
  **************************************************************************** }
