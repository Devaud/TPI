...
Type
  ...
  private
    ...
    lblHoraire : TLabel;
  public
    constructor Create(AOwner: TComponent; nomFilm, horaire : String); overload;
    procedure changeCouleur(couleur: TColor);
    procedure setText(texte: string; objet: string); 
  end;

CONST
  START_TOP     : integer = 20;
  START_LEFT    : integer = 10;
...
{ ****************************************************************************
  ...
  **************************************************************************** }
constructor TImageBouton.Create(AOwner : TComponent; nomFilm, horaire: String);
Begin
